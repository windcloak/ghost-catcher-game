// Xinmei Guo
// Youtube https://www.youtube.com/watch?v=UxMZ_L0r2Lw
...
let hasAttempt = false // check if player has tried to catch a ghost
...
function draw() {
  ...
  if (!isStart && !isEnd) {
    ...
    else if (!isCorrect && hasAttempt) fill('red')
